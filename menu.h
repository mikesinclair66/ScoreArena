...
namespace MenuItems {
	...
	class Menu {
		...
		Texture powerTextures[6] = { Texture(), Texture(), Texture(), Texture(), Texture(), Texture() };
		int powerPrices[6] = { 20, 30, 40, 40, 40, 40 };
		int powerDmg[3] = { 30, 20, 40 };
	...
	public:
		...
		static Menu* getInstance(int, int);
		...
		Color getPlayerOutlineColor(int player) {
			return
		...
		Texture* getPowerTextures() { return powerTextures; }
		int* getPowerPrices() { return powerPrices; }
		int* getPowerDamage() { return powerDmg; }
		/// <summary>
