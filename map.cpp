...
void Map::loadMenuStats() {
	loadTexture(MenuItems::Menu::getInstance(0, 0)->getMapTexture());
	players[0].setName("Player 1");
	players[0].setFillColor(MenuItems::Menu::getInstance(0, 0)->getPlayerColor(0));
	players[0].setOutlineColor(MenuItems::Menu::getInstance(0, 0)->getPlayerOutlineColor(0));
	players[1].setName("Player 2");
	players[1].setFillColor(MenuItems::Menu::getInstance(0, 0)->getPlayerColor(1));
	players[1].setOutlineColor(MenuItems::Menu::getInstance(0, 0)->getPlayerOutlineColor(1));
	players[1].setCpu(MenuItems::Menu::getInstance(0, 0)->isCpu());
	players[0].setKeyBindings(MenuItems::Menu::getInstance(0, 0)->getBindings(0));
	players[1].setKeyBindings(MenuItems::Menu::getInstance(0, 0)->getBindings(1));
	//gets the power slots from the menu
	for (int i = 0; i < 3; i++) {
		players[0].arsenal.setPowerSlot(i, MenuItems::Menu::getInstance(0, 0)->getPowerSlot(0, i));
		players[1].arsenal.setPowerSlot(i, MenuItems::Menu::getInstance(0, 0)->getPowerSlot(1, i));
	}
	initPowers();
}
